                ...
                <div class="card-body">
                    <div class="mt-4 mx-auto text-center" style="max-width:600px"> <svg width="96px" height="96px"
                        ...
                        <div class="my-3">
                            ...
                            <p>Some information will be written here, bla bla lorem ipsum you enter into any new area of
                                science, you almost always find yourself</p>
                        </div>
                    </div>
                    <ul class="steps-wrap mx-auto" style="max-width: 600px">
                        <li class="step active"> <span class="icon">1</span> <span class="text">Order received</span>
                        </li>
                        <!-- step.// -->
            ...
            <article class="card">
                <div class="card-body">
                    ...
                    <div class="itemside mb-3">
                        ...
                        <div class="info lh-sm"> <strong>Order ID: 2313440</strong> <br> <span class="text-muted">Wed, Sept
                                13, 2021</span> </div>
                    </div>
                    ...
                    <hr> <a href="https://bootstrap-ecommerce.com/components.html#" class="btn btn-light">Download
                        invoice</a>
                </div>
            </article>
            <!-- ============== COMPONENT RECEIPE .// =============== -->
