    ...
    <main class="col-md-9">
        ...
        <article class="card mb-4">
            <header class="card-header">
                <a href="#" class="float-end"> <i class="fa fa-print"></i> Print</a>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    <tbody>
                        <tr>
                            <td width="65">
                                <img src="{{ asset('frontend/images/manteau.jpg') }}" class="img-xs border">
                            </td>
                            <td>
                            ...
                            <td width="250"> <a href="#" class="btn btn-outline-primary">Track order</a>
                                <div class="dropdown d-inline-block">
                                    <a href="#" data-toggle="dropdown"
                                        class="dropdown-toggle btn btn-outline-secondary" aria-expanded="false">More</a>
